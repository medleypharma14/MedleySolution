<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchReports.aspx.cs" Inherits="Medly_Wm.BatchReports" %>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Batch Reports</span>
                                    </div>
                                    <div class="actions">
                                        <%-- <div class="btn-group">
                             ...
                             <div class="form-body">
                                   ...
                                   <div class="col-lg-12">
                                        <div class="grid" style="overflow: auto">
                                            <asp:GridView ID="batchreport" runat="server" CssClass="table table-striped table-success table-active  flip-content"  AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
