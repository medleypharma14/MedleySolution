<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SoReportNew1.aspx.cs" Inherits="Medly_Wm.SoReportNew1" %>
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body flip-scroll">
                            <div class="row">
                                <div class="col-lg-3">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" Enabled="true" OnTextChanged="txtsearch_TextChanged" AutoPostBack="true"  ID="txtsearch" runat="server" placeholder="Enter Text to Search"></asp:TextBox>
                                ...
                                <div class="col-lg-1">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group" style="margin-top: 5px;">
                                            ...
                                            <%--<asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator14" ControlToValidate="txtsupplierid"
                                                        ValidationGroup="Validation" Text="*" ErrorMessage="Please Enter Supplier ID" Style="color: Red" />--%>
                                            <asp:Button CssClass="btn btn-md gray" ID="Button2" Text="Clear" PostBackUrl="~/SoReportNew1.aspx" runat="server" />
                                        </div>
                            ...
                            <div style="overflow: auto" id="excel" runat="server">
                                <asp:GridView ID="gvSo"  runat="server" EmptyDataText="No Data Bound" DataKeyNames="Soid" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4"  ForeColor="#333333" GridLines="None">
                                ...
                                <asp:GridView ID="gvsobysts" Visible="false" runat="server" EmptyDataText="No Data Bound" DataKeyNames="Soid" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                 <AlternatingRowStyle BackColor="White" />
                                   <Columns>
                                   <asp:BoundField HeaderText="SO NO" DataField="SOPrintno" /> 
                                   <asp:BoundField HeaderText="ProductName" DataField="Productname" />  
                                  <asp:BoundField HeaderText="So Date" DataField="Sodatetime" DataFormatString="{0:dd/MM/yyyy}" />
                                  <asp:BoundField HeaderText="SoQty" DataField="SoQty" />
                                  <asp:BoundField HeaderText="Send Qty" DataField="qty" />
                                  <asp:BoundField HeaderText="Productamt" DataField="Totalamount" />
          <%-- <asp:BoundField HeaderText="Company Name" DataField="CompanyName" />
          <asp:BoundField HeaderText="Supplier Name" DataField="PersonName" />
          <asp:BoundField HeaderText="SO Date" DataField="Sodatetime" DataFormatString="{0:dd/MM/yyyy}" />
