<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsReceipt1.aspx.cs" Inherits="Medly_Wm.GoodsReceipt1" %>
                                                       ...
                                                       <div>
                                                            ...
                                                            <div class="col-lg-4" style="padding: 30px;display:none">
                                                                ...
                                                                <div class="portlet" id="List" runat="server" visible="false">
                                                                    <table>
                                                                         <tr><td> <asp:Label ID="lbl0" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl1" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl2" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl3" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl4" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl5" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl6" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl7" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl8" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl9" runat="server" Visible="false" CssClass="form-control"></asp:Label></td>
