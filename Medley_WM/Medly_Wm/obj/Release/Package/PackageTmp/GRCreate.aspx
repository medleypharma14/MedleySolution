<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GRCreate.aspx.cs" Inherits="Medly_Wm.GRCreate" %>
...
<head>
    <title>Create Goods Receipts</title>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Goods Receipts</span>
                                    </div>
                                    <div class="actions">
                                        <%--<div class="btn-group">
                                        ...
                                        <div class="btn-group">
                                            <a class="btn btn-sm green dropdown-toggle" href="GoodsReceipts.aspx" data-toggle="dropdown">Create GR
                                ...
                                ID="txtsearch" runat="server" placeholder="Enter Text to Search" Width="250px"></asp:TextBox>
                                            ...
                                            <div style="overflow: auto">
                                                <asp:GridView ID="gvProduct" runat="server" CssClass="table table-striped table-success table-active  flip-content" AutoGenerateColumns="False" OnRowCommand="gvProduct_RowCommand" CellPadding="4" ForeColor="#333333" GridLines="None">
                                                ...
                                                <ItemTemplate>
                                                    <%#Container.DataItemIndex+1 %>
                                                        ...
                                                        <asp:BoundField HeaderText="Order Quantity" DataField="PoQty" />
                                                          <asp:TemplateField HeaderText="Received Quantity" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtReceivedqty" runat="server" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtReceivedqty_TextChanged" placeholder="0"></asp:TextBox>
                                                           </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Differnce in Qty" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                            <ItemTemplate>
                                                                <asp:TextBox ID="txtTotalbatches" runat="server" CssClass="form-control" placeholder="0"></asp:TextBox>
                                                           </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="GR Grid" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="ViewGR" runat="server"   CommandArgument='<%# Container.DataItemIndex %>' 
                                                            CommandName="viewGR">

                                                            <asp:ImageButton ID="imgView" ImageUrl="~/Images/product.png" runat="server" Width="20px" CommandArgument='<%# Container.DataItemIndex %>' CommandName="viewGR" />
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
