 <%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GoodsReceipts.aspx.cs" Inherits="Medly_Wm.GoodsReceipts" EnableEventValidation="false" %>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4">
                                                            <label>Dosage Form:</label>
                                                             <asp:TextBox ID="txtDosageform" CssClass="form-control"  ReadOnly="false" runat="server"></asp:TextBox>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-4">
                                                            <label>Strength:</label>
                                                             <asp:TextBox ID="txtStrength" CssClass="form-control"  ReadOnly="false" runat="server"></asp:TextBox>
                                                          
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <label>Quantity:</label>
                                                             <asp:TextBox ID="txtOrderqty" CssClass="form-control"  ReadOnly="false" runat="server"></asp:TextBox>
                                                        </div>

                                                        <div class="col-lg-4">
                                                            <div class="form-group">
                                                            <label>Total Amount:</label>
                                                             <asp:TextBox ID="txtOrderAmount"  ReadOnly="false" CssClass="form-control" runat="server"></asp:TextBox>
                                                                </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-12" style="border: 2px solid skyblue">
                                                       <div>
                                                            ...
                                                            <div class="col-lg-2">
                                                                ...
                                                                <asp:TextBox ID="txtRecdQty" runat="server" CssClass="form-control"></asp:TextBox>
                                                            </div>
                                                            <div class="col-lg-2">
                                                                <label>Expiry date
                                                                </label>
                                                            ...
                                                            <div class="col-lg-4" style="padding: 30px;display:none">
                                                                ...
                                                                <div class="portlet" id="List" runat="server" visible="false">
                                                                    <table>
                                                                         <tr><td> <asp:Label ID="lbl0" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl1" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl2" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl3" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl4" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl5" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl6" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl7" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl8" runat="server" Visible="false"></asp:Label></td>
                                                                        ...
                                                                        <tr><td> <asp:Label ID="lbl9" runat="server" Visible="false"></asp:Label></td>
                                                                    ...
                                                                    <asp:Button ID="btnCalSubmit" runat="server" Text="Check & Submit" CssClass="btn btn-info" OnClick="btnCalSubmit_Click" />
