<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyerOrderReport.aspx.cs"
    Inherits="AdminAfforadbleApp.BuyerOrderReport" %>
                    ...
                    <ContentTemplate>
                        <div class="row">
                            <div class="col-lg-12 col-xs-12 col-sm-12">
                                <div class="portlet light " style="height: 1500px; padding-left: 3px;">
                                    <div class="portlet-title">
                                <div class="caption font-green">
                                    <i class="icon-pin font-green"></i><span class="caption-subject bold uppercase" style=" font-size:15px">BUYER ORDER REPORT</span>
                                </div>
                            </div>
                                    <div class="portlet-body">
                                            ...
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:DropDownList ID="ddlReportType" runat="server" AutoPostBack="true" Class="form-control select2">
                                                            <asp:ListItem Text="Shipment Wise Details" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <label for="form_control_1" style="    font-weight: bold;">
                                                            Buyer Code</label>
                                                        <asp:DropDownList ID="ddlBuyerCode" runat="server" AutoPostBack="true" Class="form-control select2">
                                                            <asp:ListItem Text="Shipment Wise Details" Value="1"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <label for="form_control_1" style="    font-weight: bold;">
                                                            Status</label>
                                                        <asp:DropDownList ID="drpStatus" runat="server" AutoPostBack="true" Class="form-control select2">
                                                            ...
                                                            <asp:ListItem Text="Lock" Value="5"></asp:ListItem>
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                                 <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <label for="form_control_1" style="    font-weight: bold;">
                                                            Year Code</label>
                                                        <asp:DropDownList ID="drpYearCode" runat="server" AutoPostBack="true" Class="form-control select2">
                                                ...
                                                <div class="col-lg-3" id="Div33" runat="server">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-medium date date-picker" data-date-format="dd/mm/yyyy"
                                                            ...
                                                            </span> <asp:TextBox CssClass="form-control" ID="txtFromDate" runat="server" Width="210px"
                                                ...
                                                <div class="col-lg-3" id="Div1" runat="server">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group input-medium date date-picker" data-date-format="dd/mm/yyyy"
                                                            ...
                                                            </span><asp:TextBox CssClass="form-control" ID="txtToDate" runat="server" Width="210px"
                                                                autocomplete="off"></asp:TextBox>
                                        ...
                                        <div class="portlet box green">
                                            <div class="portlet-title" style="width: 332px">
                                                <div class="caption">
                                                    <i class="fa fa-globe"></i>Shipment Wise Details</div>
                                        ...
                                        <div class="col-lg-12" style="padding-left: 4px; overflow: scroll">
                                            <asp:GridView ID="gvBuyerOrder" runat="server" OnPageIndexChanging="gvBuyerOrder_PageIndexChanging"
