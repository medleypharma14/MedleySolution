<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CurrentFabricStatusReport.aspx.cs"
    Inherits="AdminAfforadbleApp.CurrentFabricStatusReport" %>
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-xs-12 col-sm-12">
                                ...
                                <div class="caption font-green">
                                    <i class="icon-pin font-green"></i><span class="caption-subject bold uppercase" style=" font-size:15px">Current Fabric Status Report</span>
                                </div>
                            </div>
                                  ...
                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-3" id="BuyerCode" runat="server" visible="true">
                                            <div class="form-group">
                                                <label style="    font-weight: bold;">
                                                    Party Code</label>
                                                <asp:DropDownList ID="ddlPartyCode" runat="server" Class="form-control select2" Width="100%">
                                                </asp:DropDownList>
                                            </div>
                                            
                                        </div>
                                        <div class="col-lg-3" id="Div2" runat="server" visible="true">
                                        <div class="form-group">
                                                <label style="    font-weight: bold;">
                                                    Item </label>
                                                <asp:DropDownList ID="ddlItem" runat="server" Class="form-control select2" Width="100%">
                                                </asp:DropDownList>
                                            </div>
                                            </div>
                                        <div id="Div1" class="col-lg-2" runat="server" visible="false">
                                            <div class="form-group">
                                                <label style="    font-weight: bold;">
                                                    Party Name</label>
                                                <asp:DropDownList ID="ddlPartyName" runat="server" Class="form-control select2" Width="100%">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                        ...
                                        <div class="col-lg-1">
                                            <div class="form-group" id="Date" runat="server" visible="true">
                                                <asp:Label ID="lblDate" runat="server" Text="Po Date" Width="110px" Style="font-weight: bold"></asp:Label>
                                                <br />
                                        ...
                                        <div class="col-lg-1" style="display:none">
                                            ...
                                            <asp:Button ID="btnExcel" runat="server" CssClass="btn btn-primary" Text="Excel"
                                                OnClick="btnExcel_OnClick" Width="100px" />
                                        </div>
                                        <div class="col-lg-1" style="display:none">
                                            <br />
                            ...
                            <asp:GridView ID="gvPOPending" runat="server" CssClass="table table-striped table-bordered table-hover" EmptyDataText="No Records Found" OnRowDataBound="gvOrderReport_OnRowDataBound" ShowFooter="true"
                                Width="100%" OnPageIndexChanging="gvBuyerOrder_PageIndexChanging" AutoGenerateColumns="false" AllowPaging="True" PagerSettings-FirstPageText="First"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Image">
                                                        <ItemTemplate>
                                                            <asp:Image ID="Button3" runat="server" Style="font-weight: bold; height: 50px; width: 50px;
                                                                margin-top: 0px;" ImageUrl='<%#Eval("ItemImage")%>' /> 
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                     <asp:BoundField HeaderText="Exc.No. " DataField="purchasefortype" />
                                      <asp:BoundField HeaderText="Item " DataField="Item" />
                                  
                                    <asp:BoundField HeaderText="Shipment Date " DataField="ShipmentDate" DataFormatString="{0:dd/MM/yyyy}"/>
                                     <asp:BoundField HeaderText="PO Date " DataField="OrderDate" DataFormatString="{0:dd/MM/yyyy}" />
                                    <asp:BoundField HeaderText="Delivery Date " DataField="OrderDate" DataFormatString="{0:dd/MM/yyyy}" Visible="false" />
                                    ...
                                    <asp:BoundField HeaderText="BalQty " DataField="BalQty" DataFormatString="{0:f2}" ItemStyle-HorizontalAlign="Right" FooterStyle-HorizontalAlign="Right" />
                                    <asp:BoundField HeaderText=" " DataField="Units" Visible="false" />
                                </Columns>
