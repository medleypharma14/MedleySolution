...
set _DeploySetParametersFile=%RootPath%AdminAfforadbleApp.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%AdminAfforadbleApp.zip" (
echo "%RootPath%AdminAfforadbleApp.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AdminAfforadbleApp.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AdminAfforadbleApp.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AdminAfforadbleApp.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%AdminAfforadbleApp.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%AdminAfforadbleApp.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%AdminAfforadbleApp.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%AdminAfforadbleApp.deploy-readme.txt" (
...
start notepad "%RootPath%AdminAfforadbleApp.deploy-readme.txt"
)
echo =========================================================
goto :eof
