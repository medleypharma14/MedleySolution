<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductGrid.aspx.cs" Inherits="HomeAlertsAdmin.Admin.ProductGrid" %>
        ...
        function Delete(PropertyTypeID, UserID) {
            ...
            function ongoacceptsuccess(data) {
                ...
                if (data == "200") {
                    ...
                    var url = location.protocol + '//' + location.host + "/../Admin/ProductGrid.aspx";
