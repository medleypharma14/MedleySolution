<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceReminder.aspx.cs" Inherits="HomeAlertsAdmin.Admin.ServiceReminder" %>
...
<head>
    ...
    <script type="text/javascript">
        function Delete(PropertyTypeID, UserID) {
            ...
            function ongoacceptsuccess(data) {
                ...
                if (data == "200") {
                    ...
                    var url = location.protocol + '//' + location.host + "/../Admin/TicketGrid.aspx";
...
<body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-md">
      ...
      <usc:Header ID="Header" runat="server" />
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-lg-12"><div class="col-lg-3"><label>Select Month: </label>
    <asp:TextBox ID="txtMonth" runat="server" Visible="false">Mon</asp:TextBox>
    <asp:DropDownList ID="ddlMonth" runat="server" CssClass="form-control"  AutoPostBack="true"
            Width="200px" onselectedindexchanged="ddlMonth_SelectedIndexChanged" >
                  ...
                  <asp:ListItem Text="August" Value="8"></asp:ListItem>
                    <asp:ListItem Text="September" Value="9"></asp:ListItem>
                      <asp:ListItem Text="October" Value="10"></asp:ListItem>
                        <asp:ListItem Text="Novemeber" Value="11"></asp:ListItem>
    ...
    <asp:TextBox ID="txtmth" runat="server" Visible="false">Jan</asp:TextBox>
        <asp:TextBox ID="txtYear" runat="server" Visible="false"></asp:TextBox>
         <asp:DropDownList ID="ddlYear" runat="server" CssClass="form-control" AutoPostBack="true"
            Width="200px" onselectedindexchanged="ddlYear_SelectedIndexChanged" >
     ...
     <div class="col-md-12">
     <div class="col-md-12">
        <asp:GridView ID="gvgrid" runat="server" Width="100%" 
            HeaderStyle-BackColor="PaleGreen" cellpadding="30" 
          RowStyle-Height="100px"  Font-Bold="true"  
        cellspacing="50" CssClass="mGrid" RowStyle-Width="50px" RowStyle-Wrap="true" 
          onrowdatabound="gvgrid_RowDataBound" HtmlEncode="tr">
    <Columns>
    <asp:TemplateField>
    <ItemTemplate>
    <asp:Button ID="btnShow" runat="server" Text="Show Me"  Visible="false"/>
    </ItemTemplate>
    </asp:TemplateField>
    </Columns>
    </asp:GridView>
