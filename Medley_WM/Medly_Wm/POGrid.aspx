                            ...
                            <div class="caption">
                                ...
                                <div class="portlet-body flip-scroll">
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="gvPo" runat="server" EmptyDataText="No Data Bound" DataKeyNames="Poid" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4" OnRowDataBound="gvPo_RowDataBound" ForeColor="#333333" GridLines="None" OnRowCommand="gvPo_RowCommand">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Print" ItemStyle-HorizontalAlign="Center" Visible="true">
                                                   ...
                                                   <asp:TemplateField HeaderText="GR Grid" ItemStyle-HorizontalAlign="Center" Visible="false">
                                                    <ItemTemplate>
