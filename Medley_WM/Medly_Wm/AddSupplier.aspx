<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddSupplier.aspx.cs" Inherits="Supplier.AddSupplier" %>
                            ...
                            <div class="portlet light ">
                                ...
                                <div class="form-body">
                                        ...
                                        <div class="col-lg-12" style="border:2px solid skyblue">
                                            ...
                                            <div class="col-lg-12" >
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="txtcompanyname"
                                                        ValidationGroup="Validation" Text="*" ErrorMessage="Please Enter Company Name" Style="color: Red" />
                                    ...
                                    <div class="col-lg-12" style="padding-top: 20px">
                                        ...
                                        <div style="float: left; padding-top: 7px; margin-left: 200px;">
                        ...
                        <div class="row">
                            <center>
                                <div cl="col-lg-12" style="padding-top: 20px">
                                    ...
                                    <asp:Button ID="btncancel" runat="server" class="btn blue" Text="Cancel" Style="float: left" />
                                    <asp:Button ID="btnclear" runat="server" class="btn default" Text="Clear" Style="float: left" />

                                    <asp:Button ID="btnsave" runat="server" class="btn blue" Text="Save" Style="float: right" ValidationGroup="Validation" />
                                </div>
                            </center>
                        </div>
                            </div>
