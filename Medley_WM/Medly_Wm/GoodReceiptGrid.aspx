            ...
            <div class="page-content">
                <form id="form2" runat="server">
                            ...
                            <div class="caption">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                       ...
                                       <div class="col-lg-3">
                                           <div class="form-group">
                                               <b>
                                               <asp:RadioButtonList Font-Bold="true" runat="server" ID="poret" OnSelectedIndexChanged="poret_SelectedIndexChanged" AutoPostBack="true" RepeatDirection="Horizontal" CellPadding="10">
                                                   <asp:ListItem Text="PO Order" />
                                                   <asp:ListItem Text="Return Order" />
                                               </asp:RadioButtonList>
                                                   </b>
                                           </div>
                                       </div>
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <a class="btn red" href="GoodReceiptNew.aspx" data-toggle="dropdown">ADD Goods
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="gvPo" runat="server" EmptyDataText="No Data Available" DataKeyNames="GRId" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" CellPadding="4" OnRowDataBound="gvPo_RowDataBound" ForeColor="#333333" GridLines="None" OnRowCommand="gvPo_RowCommand">
