...
namespace Medly_Wm
{
    public partial class SoReportNew1 : System.Web.UI.Page
    {
        ...
        protected void btnexp_Click(object sender, EventArgs e)
        {
            ...
            if (ddlsts.SelectedIndex == 0 || ddlsts.SelectedItem.Text == "Draft"|| ddlsts.SelectedItem.Text == "Approved")
            {
                gvSo.RenderControl(htmlWrite1);
            }
            else
            {
                gvsobysts.RenderControl(htmlWrite1);
            }
        ...
        public void BindSoby_Status()
        {
            ...
            {        
                gvSo.Visible = true;
                gvsobysts.Visible = false;
                BindSo();
               
            }
            else
            {
                string sts = ddlsts.SelectedItem.Text.ToString();
                if(sts == "Draft" || sts == "Approved")
                {
                    gvSo.Visible = true;
                    gvsobysts.Visible = false;
                ...
                {
                    gvSo.Visible = false;
                    gvsobysts.Visible = true;
                    DataSet ds = dbObj.SoReport_grid1(sts,Convert.ToDateTime(txtFromdate.Text), Convert.ToDateTime(txtTodate.Text));
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        //    dtrp.Rows.Add(newRow);
                        // }
                        gvsobysts.DataSource = ds;
                        gvsobysts.DataBind();
                    }
                    else
                    {
                        gvsobysts.DataSource = null;
                        gvsobysts.DataBind();
                    }
