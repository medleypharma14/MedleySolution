<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WareHouseStock.aspx.cs" Inherits="Medly_Wm.WareHouseStock" %>
...
<%@ Register TagPrefix="usc" TagName="Header" Src="~/Header.ascx" %>
    ...
    <head>
        <title>Ware House Stock Grid</title>
                              ...
                              <div class="col-md-12 ">
                                   <div class="portlet light ">
                                        ...
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">WareHouse Stock Grid</span>
                                        </div>
                                       <%-- <div class="actions">--%>
                                           <%-- <div class="btn-group">
