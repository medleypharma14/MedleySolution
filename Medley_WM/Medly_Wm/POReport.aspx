                            ...
                            <div class="caption">
                                ...
                                <div class="portlet-body flip-scroll">
                                    <div class="row">
                                        <div class="col-lg-2" style="padding-top: 5px">
                                            <div class="form-group">
                                                <label></label>
                                                <asp:TextBox CssClass="form-control" Enabled="true" onkeyup="Search_Gridview(this, 'PoReport')"
                                    ...
                                    <div style="overflow: auto">
                                        <asp:GridView ID="PoReport" runat="server" EmptyDataText="No Data Bound" DataKeyNames="Poid" CssClass="table table-bordered table-striped table-success" OnRowDataBound="PoReport_RowDataBound" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="PO NO" DataField="POPrintno" Visible="false" /> 
