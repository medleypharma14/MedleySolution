                        ...
                        <div class="portlet-body flip-scroll">
                            ...
                            <div class="row" id="excel" runat="server">
                                <div style="overflow: auto">
                                    <asp:GridView ID="PoReport" runat="server" EmptyDataText="No Data Bound" OnRowDataBound="PoReport_RowDataBound" DataKeyNames="Poid" CssClass="table table-bordered table-striped table-success" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Qty" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label Text='<%#Eval("PoQty") %>' ID="lblQty" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Remain Qty">
                                                <ItemTemplate>
                                                    <asp:Label Text="0" ID="lblRemainQty" runat="server" Visible="false" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Remain Qty" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label Text='<%#Eval("Poid")+";"+Eval("Productid") %>'  ID="rdetails" runat="server" />
                                                </ItemTemplate>
                                            </asp:TemplateField>
