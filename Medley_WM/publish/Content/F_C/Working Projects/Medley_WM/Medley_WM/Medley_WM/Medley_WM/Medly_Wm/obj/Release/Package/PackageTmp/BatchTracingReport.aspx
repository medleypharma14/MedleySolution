<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchTracingReport.aspx.cs" Inherits="Medly_Wm.BatchTracingReport" %>
...
<head>
    <title>Batch Tracing Reports</title>
                            ...
                            <div class="portlet light ">
                                <div class="portlet-title">
                                    <div class="caption font-red-sunglo">
                                        ...
                                        <span class="caption-subject bold uppercase">Batch Tracing Reports</span>
                                    </div>
                                    <div class="actions">
                                        <%-- <div class="btn-group">
                             ...
                             <div class="form-body">
                                  ...
                                  <div class="col-lg-12">
                                        <div class="grid" style="overflow: auto">
                                            <asp:GridView ID="batchtracingreport" runat="server" CssClass="table table-striped table-success table-active  flip-content"  AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None">
