<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductStockSpecific.aspx.cs" Inherits="Medly_Wm.ProductStockSpecific" %>
...
<%@ Register TagPrefix="usc" TagName="Header" Src="~/Header.ascx" %>
    ...
    <head>
        <title>Product Stock Specific Grid</title>
                              ...
                              <div class="col-md-12 ">
                                   <div class="portlet light ">
                                        ...
                                        <div class="caption font-red-sunglo">
                                            ...
                                            <span class="caption-subject bold uppercase">Product Stock Specific</span>
                                        </div>
                                       <%-- <div class="actions">--%>
                                           <%-- <div class="btn-group">
