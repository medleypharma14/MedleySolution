                        ...
                        <div class="row">
                          <%--  <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>--%>
                                        <asp:GridView ID="sopickgrid" runat="server" OnDataBound="sopickgrid_DataBound" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" ForeColor="#333333" GridLines="Both" Visible="false">
