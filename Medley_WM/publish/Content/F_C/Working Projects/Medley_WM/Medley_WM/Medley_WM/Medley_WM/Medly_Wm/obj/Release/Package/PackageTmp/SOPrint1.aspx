<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SOPrint1.aspx.cs" Inherits="Medly_Wm.SOPrint1" %>
                                    ...
                                    <div class="form-body" style="width:90%">
                                        ...
                                        <div class="col-lg-12" style="margin-left:20px">
                                            ...
                                            <div style="float: right; margin-right:80px;">
                                                <h4>
                                                    <b>So No:  </b>
                                                    <asp:Label ID="lblSonumber" runat="server"></asp:Label>
                                                </h4>
                                            </div>
                                        </div>
                                        <div class="col-lg-12" style="margin-left:20px">
                                         ...
                                         <div class="col-lg-12">
                                                        <asp:GridView ID="grvSo" runat="server" Width="95%" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" CellPadding="4" GridLines="None">
                                             ...
                                             <div class="col-lg-12" style="margin-left:20px">
                                                    <table>
                                                <tr>
                                                    <td align="left" style="padding-left: 500px" runat="server" visible="false"><b>250 Days from BOL</b>
                                                    </td>
                                                    <td align="left" style="padding-left:450px">
                                                        <b>Total Qty
                                                            <asp:Label ID="txtTotalqty" runat="server" />
                                                        </b>
                                                        
                                                    </td>
                                                    <td style="float:right;padding-right:90px;margin-right:20px">
                                                       <b> Total Amount:
