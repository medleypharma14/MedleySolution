<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="POPrint.aspx.cs" Inherits="Medly_Wm.POPrint" %>
                                    ...
                                    <div class="form-body">
                                        <div >
                                           ...
                                           <div class="col-lg-12">
                                               ...
                                               <br />
                                               <div style="float:right;margin-right:200px" ><b>Po No:
                                              </b><asp:Label id="lblponumber" runat="server"></asp:Label>
                                                    </div>
                                                </div>
                                            <div class="col-lg-12">
                                            <div style="float:left;padding-top:10px">
                                        ...
                                        <asp:GridView ID="grvPo"  runat="server" CssClass="table table-bordered table-striped table-condensed flip-content" AutoGenerateColumns="False" ForeColor="#333333" HorizontalAlign="Center" ShowHeaderWhenEmpty="True" CellPadding="4" GridLines="None" >
                                            ...
                                            <table style="margin-left: 550px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <asp:PlaceHolder ID="PlaceHolder10" runat="server">xxxx</asp:PlaceHolder>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Delivery Charges
